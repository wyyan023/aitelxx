$(function($) {
    ...
    if (storage) {
        try {
            ...
            var fixedHeader = 'fixed-header'; //localStorage.getItem('config-fixed-header');
            ...
            var fixedLeftmenu = 'fixed-leftmenu';//localStorage.getItem('config-fixed-leftmenu');
    ...
    function() {
        ...
        if (!$item.hasClass('open')) {
            $item.parent().find('.open .submenu').slideUp('normal');
        ...
        if ($item.hasClass('open')) {
            $item.children('.submenu').slideDown('normal');
            var $icon = $item.parent().find('.fa-angle-down');
            $icon.removeClass('fa-angle-down');
            $icon.addClass('fa-angle-right');
            
            var $icon = $item.find('.fa-angle-right');
            //$icon.removeClass('fa-angle-right');
            //$icon.addClass('fa-angle-down')
        } else {
            ...
            $item.children('.submenu').slideUp('normal');
        }
    });
