...
class Device extends User{
	...
	public function addLine(){
		...
		// $max_destination_extension = Db::name('tel_sim')->field('destination_extension')->order('id desc')->find();	
		// if ($max_destination_extension && $max_destination_extension['destination_extension'] > 0){
			// $data['destination_extension'] = ((int)$max_destination_extension['destination_extension'])+1;
		// }
		// else{
			// $data['destination_extension'] =  config('destination_extension');
		// }
		...
		// if (config('linewatch')){
			// $linewatch = config('linewatch');
			// $data['dial_format'] = $linewatch['dial_format'];
			// $data['originate_variables'] = $linewatch['originate_variables'];
		// }
